...
WebUI.callTestCase(findTestCase('My Account/General Information/UploadValidPhotoID'), [('FilePath') : ''], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('My Account/General Information/UploadBusinessLicense'), [('FilePath') : ''], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('My Account/General Information/UploadProfilePhoto'), [('FilePath') : ''], FailureHandling.STOP_ON_FAILURE)
